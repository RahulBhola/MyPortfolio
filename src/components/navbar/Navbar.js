          ...
          <div className="w-[80%] h-screen overflow-scroll absolute top-0 left-0 bg-gray-900 p-4 scrollbar-hide">
            <div className="flex flex-col gap-8 py-2 relative">
              <div>
                ...
                I am Enthusiastic about creating and implementing efficient and maintainable code. Skilled at finding important information from complicated data and showing it through helpful visualizations. Enthusiastic about using data-driven methods to solve problems.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  <span className="bannerIcon"  onClick={()=> window.open("https://github.com/RahulBhola","_blank","noopener noreferrer")}>
                    <FaGithub />
                  </span>
