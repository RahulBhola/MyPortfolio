  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-14">
        <ProjectsCard
          title="Crop Deal Website"
          des="Built multi-role platform (Farmer/Dealer/Admin) with secure authentication using ASP.NET Identity & JWT."
          src={cropDeal}
          projectLink="https://github.com/RahulBhola/CropDeal"
          webLink="https://youtu.be/9gZMp6sAFLI"
        />
        <ProjectsCard
